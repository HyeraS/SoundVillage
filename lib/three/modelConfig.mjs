...
export const ANIMAL_PLAYER_START = Object.freeze(scaleZonePosition([0, 0, 6.8]))

export const ANIMAL_EXIT_TARGET = Object.freeze({
  id: 'animal-village-exit',
  kind: 'village-exit',
  villageId: 'animal',
  label: '중앙 광장 출구',
  position: Object.freeze(scaleZonePosition([0, 0, 6.7])),
  interactionRadius: 1.9,
})
...
const BASE_ANIMAL_COLLIDERS = [
  { id: 'animal-shelter', position: [-8.2, -3.5], size: [3.8, 3], height: 3.4 },
  { id: 'animal-pond', position: [7.2, -2.5], size: [4, 3.3], height: 0.12 },
  { id: 'animal-tree-west', position: [-10.2, 1.2], size: [1.35, 1.35], height: 3.2 },
  { id: 'animal-tree-east', position: [10.2, 1.6], size: [1.35, 1.35], height: 3.2 },
  { id: 'animal-tree-north-west', position: [-9.8, 6.7], size: [1.3, 1.3], height: 3.1 },
  { id: 'animal-tree-north-east', position: [9.8, 6.7], size: [1.3, 1.3], height: 3.1 },
]

export const ANIMAL_WORLD_COLLIDERS = Object.freeze(BASE_ANIMAL_COLLIDERS.map(collider => Object.freeze({
  ...collider,
  position: Object.freeze(scaleZonePosition(collider.position)),
  size: Object.freeze([...collider.size]),
})))
...
export const ANIMAL_ENVIRONMENT_CONFIG = Object.freeze({
  groundTopRadius: 13.2 * ZONE_LINEAR_SCALE,
  groundBottomRadius: 12.7 * ZONE_LINEAR_SCALE,
  shelterPosition: Object.freeze(scaleZonePosition([-8.2, -3.5])),
  pondPosition: Object.freeze(scaleZonePosition([7.2, -2.5])),
  exitPath: Object.freeze({ width: 2.3, length: 6.2, position: Object.freeze(scaleZonePosition([0, 5.1])) }),
})

export const VILLAGE_RUNTIME_CONFIG = Object.freeze({
  music: Object.freeze({
    sceneId: 'music',
    dataZone: 'Music',
    displayName: 'Music',
    ...
    exitTarget: MUSIC_EXIT_TARGET,
    cameraDebugLabel: 'music-third-person',
  }),
  animal: Object.freeze({
    sceneId: 'animal',
    dataZone: 'Animal',
    displayName: 'Animal',
    playerStart: ANIMAL_PLAYER_START,
    worldBounds: WORLD_BOUNDS,
    worldColliders: ANIMAL_WORLD_COLLIDERS,
    exitTarget: ANIMAL_EXIT_TARGET,
    cameraDebugLabel: 'animal-third-person',
  }),
})

export function getVillageRuntimeConfig(sceneId) {
  return VILLAGE_RUNTIME_CONFIG[sceneId] || VILLAGE_RUNTIME_CONFIG.music
}
