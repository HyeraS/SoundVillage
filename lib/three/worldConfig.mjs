...
function createExit(id, label, color, position, dataZone) {
  const frozenPosition = Object.freeze(position)
  return Object.freeze({ id, label, color, dataZone, position: frozenPosition, rotationY: getGatewayYaw(frozenPosition) })
}

export const HUB_EXITS = Object.freeze([
  createExit('animal', 'Animal', '#F0A17D', [-10.3, 0, 5.7], 'Animal'),
  createExit('human', 'Human', '#F2B68D', [-10.8, 0, 0.9], 'Human'),
  createExit('nature', 'Nature', '#74B978', [-9.8, 0, -6.9], 'Nature'),
  createExit('urban', 'Urban', '#63AFA5', [10.4, 0, 5.6], 'Urban'),
  createExit('music', 'Music', '#E88C72', [10.9, 0, 0.8], 'Music'),
  createExit('unknown', 'Unknown', '#8AAE8D', [10, 0, -7], 'Lab'),
])
...
export function getPrototypeScene(searchParams) {
  ...
  if (scene === 'music') return 'music'
  if (scene === 'animal' && params.has('mock')) return 'animal'
  return HUB_SCENE_ID
}
